...
fun safeUserInput(wordLength: Int, alphabet: String): String {
    ...
    do {
        ...
        input = safeReadLine()
        correctInput =  isCorrectInput(input, wordLength, alphabet)
    } while (!correctInput)
...
fun main() {
    ...
    playGame(generateSecret(4, alphabet), wordLength, maxAttemptsCount, alphabet)
}
